        ...
        <div class="footer-content">
            ...
            <div class="footer-map">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.294683886142!2d106.61638579999999!3d10.865176600000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752a10b0f0554f%3A0x769800e8967d6703!2zNzAgxJAuIFTDtCBLw70sIFTDom4gQ2jDoW5oIEhp4buHcCwgUXXhuq1uIDEyLCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1725285805117!5m2!1svi!2s"
            ...
            <div class="footer-info-section">
                ...
                <div class="footer-newsletter">
                    <h3><i class="fas fa-envelope"></i> Nhận tin tức mới nhất</h3>
                    <p>Đăng ký để nhận thông báo về sản phẩm mới và ưu đãi đặc biệt</p>
                    <div class="newsletter-form">
                        <input type="email" placeholder="Nhập email của bạn..." required>
                        <button type="submit">
                            <i class="fas fa-paper-plane"></i>
                ...
                <div class="footer-links">
                    ...
                    <div class="footer-col">
                        <h4>Hỗ trợ</h4>
                        <ul>
                            <li><a href="#"><i class="fas fa-angle-right"></i> Hướng dẫn đặt hàng</a></li>
                ...
                <div class="footer-contact">
                    ...
                    <div class="contact-info">
                        <div class="contact-item">
                            ...
                            <span>70 Tô Ký, Tân Chánh Hiệp, Quận 12, Hồ Chí Minh</span>
                        </div>
                        <div class="contact-item">
                            <i class="fas fa-envelope"></i>
                            <span>voxfootballvn@gmail.com</span>
                        </div>
                        <div class="contact-item">
                            <i class="fas fa-phone"></i>
                            <span>0981772800</span>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-content">
                ...
                <div class="footer-copyright">
                    <p>&copy; 2024 VOXFootball. All rights reserved. Designed with <i class="fas fa-heart"
...
<script src="/public/js/signup-login.js"></script>
